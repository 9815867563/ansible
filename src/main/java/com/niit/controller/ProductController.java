...
public class ProductController {
	...
	public ModelAndView createProduct(@Valid @ModelAttribute(value = "createProductObj") Product product,
		...
		if (result.hasErrors())
			...
			if (prodImage != null || !prodImage.isEmpty()) {
				...
				// store this Image
				Path paths = Paths
						.get("C:/Users/R@HUL/git/Ecommerce-complete/EcommerceProject/src/main/webapp/WEB-INF/resources/images/"
								+ product.getId() + ".png");
				try {
	...
	public ModelAndView getEditProductForm(@PathVariable(value = "id") int id) {
		...
		mv.addObject("createProductObj",product);
		mv.setViewName("createProductForm");
		//return new ModelAndView("createProductForm", "createProductObj", product);
		return mv;
	}
